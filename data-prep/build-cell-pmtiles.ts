...
(async () => {
  ...
  console.log(
    "pmtiles files created for all stops. To join into a single pmtiles archive, run the following:"
  );
  console.log("tile-join -o output/all-stops.pmtiles output/cells-*.pmtiles");
})();
