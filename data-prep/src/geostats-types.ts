// This SeaSketch package isn't published on npm, so for now I'm just copying
// the types here. Original is at:
// https://github.com/seasketch/next/blob/master/packages/geostats-types/lib/index.ts
